...
const CLOUDSCAPE_STEPS: StepContent[] = [
    ...
    blocks: [
      ...
      { type: "heading", text: "Pro tips" },
      {
        ...
        items: [
          ...
          { text: "Use \"clear chat\" when switching from one large feature to another to optimize context." },
        ],
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            text: "Open the Builder.io Figma plugin on the design file you just opened. Click Login in the plugin and authorize it against this space. Select the layer you want to export to Builder, then use the plugin's Smart Export feature to export it. Copy the results from Figma and paste them into Builder's chat box.",
            link: {
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "prompt",
        text: "Add stories for only the components used in the new dashboard we built, with controls for switching between the light, dark, and creative themes so we can see how the new theming affects each component. Add a link in the dashboard header to open Storybook at the /storybook/ route, plus a link back to the dashboard from Storybook.",
      },
      {
        type: "bullets",
        items: [
    ...
    blocks: [
      ...
      { type: "heading", text: "Other recommendations" },
      {
        ...
        items: [
          ...
          { text: "Add 3d data visualization with loose requirements", example: "\"Use three.js to add an experimental creative 3D data visualization to the top of the dashboard\"" },
        ],
      },
    ...
    <div className="workshop-scale min-h-screen flex flex-col bg-slate-50">
      ...
      <footer className="w-full bg-gray-100 border-t border-gray-200">
        <div className="mx-auto max-w-7xl px-4 py-2 md:px-6 text-center text-sm text-gray-600">
          Builder.io &lt;&gt; Amazon Cloudscape Workshop Seattle 2026
        </div>
      </footer>
    </div>
  );
